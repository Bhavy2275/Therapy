...
import { IconUser, IconClipboard } from '@/components/Icons';
  ...
  return (
    <div className="glass fade-in-up" style={{ width: '100%', maxWidth: 460, borderRadius: '1.25rem', padding: '2.5rem' }}>
      ...
      <div style={{
        ...
        borderRadius: '0.65rem', padding: '0.25rem', marginBottom: '1.5rem',
        ...
        {(['client', 'therapist'] as const).map((r) => (
          ...
          >
            {r === 'client' ? <><IconUser size={14} style={{ verticalAlign: 'middle', marginRight: '0.3rem' }} />I need therapy</> : <><IconClipboard size={14} style={{ verticalAlign: 'middle', marginRight: '0.3rem' }} />I am a therapist</>}
          </button>
        ))}
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        {role === 'therapist' && (
          <div style={{
            ...
            ℹ️ Therapist accounts require license verification before going live. You&apos;ll complete your profile after registration.
          </div>
        )}
